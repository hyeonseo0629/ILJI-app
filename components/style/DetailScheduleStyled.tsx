...
export const ModalOverlay = styled(Pressable)<StyledProps>`
    flex: 1;
...
export const Container = styled.View<StyledProps>`
    ...
    border-radius: 20px;
    border-width: 6px;
    border-color: ${props => props.$colors?.borderColor || 'lavender'};
    max-height: 93%;
    elevation: 10;
`;
...
export const Header = styled.Text<StyledProps>`
    ...
    border-bottom-color: ${props => props.$colors?.pointColors?.purple || 'lavender'};
...
export const HeaderInput = styled.TextInput<StyledProps>`
    ...
    padding-bottom: 20px;
    border-bottom-width: 5px;
    border-bottom-color: ${props => props.$colors?.borderColor || 'lavender'};
    color: ${props => props.$colors?.text || 'black'};
    margin-bottom: 25px;
`;
...
export const DateTimeInfoRow = styled.View<{ $colors?: ThemeColors }>`
    flex-direction: row;
    align-items: center;
...
export const DateTimeInfo = styled.View<{ $colors?: ThemeColors }>`
    flex-direction: row;
    align-items: center;
    flex: 1;
`;
...
export const DateTimeTexts = styled.View<{ $colors?: ThemeColors }>`
    flex: 1;
`;
...
export const ValueText = styled.Text<StyledProps>`
    width: 100%;
    background-color: ${props => props.$colors?.background || '#f4f4fd'};
    padding: 14px 16px;
    border-radius: 12px;
    font-size: 16px;
...
export const AllDayRow = styled.View<StyledProps>`
    ...
    border-color: ${props => props.$colors?.borderColor || '#eee'};
`;

export const DateTimePickersRow = styled.View<{ $colors?: ThemeColors }>`
    flex-direction: row;
    justify-content: space-between;
    margin-bottom: 25px;
`;
...
export const DateTimePickerButtonText = styled.Text<StyledProps>`
    color: ${props => props.$colors?.pointColors.purple || '#484389'};
    font-size: 16px;
    font-weight: 600;
`;

export const TagSelectorContainer = styled.View<{ $colors?: ThemeColors }>`
    flex-direction: row;
    flex-wrap: wrap;
    gap: 10px;
    margin-bottom: 25px;
...
export const TagSelectorItem = styled.TouchableOpacity<StyledProps & { selected: boolean; color?: string; }>`
    ...
    border-radius: 20px;
    border-width: 2px;
    border-color: ${({ color, $colors }) => color || $colors?.borderColor || 'gray'};
...
export const TagSelectorText = styled.Text<StyledProps & { selected: boolean }>`
    color: ${({ selected, $colors }) => selected ? ($colors?.background || 'white') : ($colors?.text || 'black')};
    font-weight: bold;
`;

export const DeleteButton = styled.TouchableOpacity<{ $colors?: ThemeColors }>`
    padding: 5px;
    margin-left: 10px;
`;

export const SelectedTagWrap = styled.View<{ $colors?: ThemeColors }>`
     flex-direction: row;
     flex-wrap: wrap;
 `;

export const SelectedTag = styled.View<{ $colors?: ThemeColors } & { color: string }>`
     flex-direction: row;
     align-items: center;
...
export const SelectedTagText = styled.Text<StyledProps>`
     color: ${props => props.$colors?.borderColor || '#ffffff'};
     font-weight: bold;
     font-size: 18px;
 `;
...
export const ButtonArea = styled.View<StyledProps>`
    flex-direction: row;
    background-color: ${props => props.$colors?.background || '#f9f9f9'};
...
export const ActionButton = styled.TouchableOpacity<StyledProps & { primary?: boolean }>`
    ...
    padding: 18px;
    align-items: center;
    background-color: ${({ primary, $colors }) => primary ? ($colors?.pointColors.purple || '#9970FF') : ($colors?.background || '#eef0f4')};
`;

export const ActionButtonText = styled.Text<StyledProps & { primary?: boolean }>`
    font-size: 22px;
    font-weight: bold;
    color: ${({ primary, $colors }) => primary ? ($colors?.background || 'white') : ($colors?.pointColors.purple || '#9970FF')};
`;

export const ButtonSeparator = styled.View<StyledProps>`
    width: 1px;
    background-color: ${props => props.$colors?.borderColor || 'lavender'};
`;
